...
def main():
    ...
    parser.add_argument('-q', '--quality',
                        help='''Movie Quality.
                                Valid arguments are: "all", "720p", "1080p", "3d"
                             ''',
                        dest='quality',
                        type=str.lower,
                        required=False,
    ...
    parser.add_argument('-g', '--genre',
                        help='''Movie Genre.
                                Valid arguments are: "all", "action", "adventure",
    ...
    parser.add_argument('-s', '--sort-by',
                        help='''Sorting options.
                                Valid arguments are: "title", "year", "rating",
                                "latest", "peers", "seeds", "download_count",
    ...
    parser.add_argument('-m', '--multiprocess',
                        help='''Append -m to download using multiprocessor.
